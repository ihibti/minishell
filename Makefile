...
SRC = src/parsing/env.c src/parsing/expands.c src/parsing/expands_utils.c src/parsing/utils.c src/parsing/lexing.c\
	src/parsing/split_request.c src/parsing/syntax.c src/parsing/post_parsing.c src/parsing/automate.c\
	...
	src/redir/redirec_main.c src/redir/redirec_utils.c src/redir/redirec_utils2.c src/redir/expand_hd.c\
